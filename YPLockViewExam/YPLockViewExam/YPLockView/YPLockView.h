...
typedef void(^YPLockViewDidFinishPathBlock)(YPLockView *lockView,NSString *password);
...
/** block */
@property (nonatomic, copy) YPLockViewDidFinishPathBlock didFinishPathBlock;
/** 视图多种锁的类型 */
